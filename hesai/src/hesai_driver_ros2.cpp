...
bool HesaiDriver::start() {
    ...
    try {
        ...
        running_ = true;
        io_thread_ = std::make_shared<boost::thread>(
            boost::bind(&HesaiDriver::runIOService, this));
...
void HesaiDriver::startReceive() {
    ...
    data_socket_->async_receive_from(
        ...
        data_endpoint_,
        boost::bind(&HesaiDriver::handleDataReceive, this,
    ...
    position_socket_->async_receive_from(
        ...
        position_endpoint_,
        boost::bind(&HesaiDriver::handlePositionReceive, this,
                   boost::asio::placeholders::error,
                   boost::asio::placeholders::bytes_transferred));
}
